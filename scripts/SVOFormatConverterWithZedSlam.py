...
def main():
    ...
    rightToLeft = cam.get_camera_information(resizer=sl.Resolution(640,480)).calibration_parameters.stereo_transform
    rightToLeft.inverse()
    trans.inverse()
    trans = np.matmul(rightToLeft.m, trans.m)
    print("sensor pose R inverse", trans)
    ...
    trans = cam.get_camera_information(resizer=sl.Resolution(640,480)).camera_imu_transform
    trans.inverse()
    print("imu to camera trans", trans)
    '''
    while True:  
